...
// SaveWithOutboxEvent grava o pedido, os itens e o evento de outbox numa
// única transação. Se o commit falhar em qualquer ponto, nada é persistido —
// é essa garantia que faz o outbox funcionar: nunca existe pedido sem evento
// correspondente pendente de publicação, nem evento sem pedido.
